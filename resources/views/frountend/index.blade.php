...
<div id="vfx-product-inner-item" style="background-color: rgb(253, 253, 253);">
    <div class="container-fluid">
        <div class="row m-4">
            <!-- Sidebar -->
            <div class="col-md-3 col-sm-4 col-xs-12" style="padding: 0 0 0 20px;">
                <div class="sidebar" style="max-width: 100%; padding: 40px 10px 30px; background-color: white;">
                    <div class="list-group v-wrapper" style="border: 1px solid black;">
                        <h5 class="text-center text-warning mb-3">Categories</h5>
                        <ul class="v-list animated fadeIn">
                            @foreach ($sections as $section)
                            @if (count($section['categories'])>0)
            ...
            <div class="col-md-9 col-sm-8 col-xs-12" style="padding-right: 50px;">
                ...
                <div class="page-bar clearfix">
                    <div class="shop-settings">
                        <a id="list-anchor" class="active"><i class="fa fa-th"></i></a>
                        <a id="grid-anchor"><i class="fa fa-th-list"></i></a>
                    </div>
                    <!-- Toolbar Sorter -->
                    <div class="toolbar-sorter">
                        <div class="select-box-wrapper">
